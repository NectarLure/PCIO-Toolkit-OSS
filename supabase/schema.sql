...
-- Browser RPC execution permissions.
-- The public website uses anon/authenticated roles only through security-definer
-- RPC functions that verify project codes and fill/view access codes internally.
-- Direct anonymous table reads remain blocked by RLS policies.
